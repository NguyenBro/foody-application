...
public class AllOrderFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor data = IntroActivity.database.getData("SELECT * FROM bill WHERE id_user ='"+ MainActivity.user.getPhone()+"' ORDER BY id DESC");
